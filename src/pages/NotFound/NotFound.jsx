...
export default function NotFound() {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-gradient-to-b from-navy via-navy-light to-[#102f58]">
      <div
        aria-hidden="true"
      ...
      <section className="container-wrapper flex min-h-[calc(100vh-96px)] items-center py-28 md:py-32">
        <div className="w-full p-8 text-white sm:p-10">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-white/80 sm:text-xl">
            Looks like this page drifted off course. The link may be broken, or
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Link
              to="/projects"
              className="inline-flex items-center rounded-2xl border border-white/35 px-8 py-4 text-base font-semibold text-white transition-colors duration-200 hover:bg-white hover:text-navy sm:text-lg"
            >
              Browse Projects
            </Link>
          </div>
