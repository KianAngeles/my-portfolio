...
export default function ProjectsPage() {
  ...
  return (
    <main className="projects-page relative isolate min-h-screen overflow-x-clip bg-gradient-to-b from-slate-50 via-sky-50/70 to-white dark:from-navy dark:to-navy-light">
      <div
      ...
      <div className="relative z-10">
        <ProjectsHero shouldAnimateIntro={shouldAnimateIntro} phaseDelay={PHASE_DELAYS.hero} />
        <ProjectsHighlightsSection shouldAnimateIntro={shouldAnimateIntro} phaseDelay={PHASE_DELAYS.stats} />
        <ProjectsGridSection shouldAnimateIntro={shouldAnimateIntro} phaseDelay={PHASE_DELAYS.selectedBuilds} />
        <Footer />
      </div>
    </main>
  );
